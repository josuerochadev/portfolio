...
export default function Timeline() {
	...
	return (
		<div className="relative z-0 w-full">
			...
			<nav aria-label="Timeline navigation" className="sticky top-6 z-20 ml-6 md:ml-0 w-fit rounded-full flex items-center gap-2 px-4 py-2 sm:px-6 sm:py-3 bg-gradient-to-br from-lime/20 via-orange/10 to-violet/5 dark:from-lime/10 dark:via-orange/5 dark:to-violet/10 backdrop-blur-md border border-lime/30 dark:border-lime/20 shadow-glow-lime hover:shadow-glow-lime-lg hover:bg-lime dark:hover:bg-lime/20 active:scale-95 transition-transform duration-150 mb-6">
				{years.map((year, i) => (
