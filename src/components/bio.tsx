...
import ProfileBackground from "./profile_background";
...
export default function Bio() {
	...
	const sections = [
		{
			title: "approach",
			text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum accumsan nec nulla vitae scelerisque.",
		},
		{
			title: "background",
			text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum accumsan nec nulla vitae scelerisque.",
	...
	return (
		<section
			id="bio"
			className="relative z-10 w-full bg-beige dark:bg-darkgray px-6 py-20 text-violet overflow-hidden"
		>
			<ProfileBackground />
			<div className="max-w-6xl mx-auto flex flex-col items-center">
				...
				>
					<LetterRippleEffect text="And " />
					<LetterRippleEffect text="more " />
					<LetterRippleEffect text="about " />
					<LetterRippleEffect text="me" />
				</motion.h2>
				...
				<div className="w-full px-4 max-w-4xl flex flex-col gap-20 text-center md:text-left">
					{sections.map((section, i) => (
						...
						>
							<h3 className="text-2xl font-serif font-bold text-violet mb-2">
								{section.title}
							</h3>
